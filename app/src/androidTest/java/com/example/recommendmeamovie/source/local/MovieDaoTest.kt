...
class MovieDaoTest {
    ...
    fun insertAndRead() = runBlockingTest {
        val movieEntity = MovieEntity(0, 0, "Chungking Express", "", "1994-9-26", "top_rated")
    ...
    fun insertListAndRead() = runBlockingTest {
        val movieList = listOf(
            MovieEntity(0,0, "Zack Snyder's Justice League", "", "2021-3-18", "popular"),
            MovieEntity(1,1, "Parasite", "", "2019-5-30", "popular"),
            MovieEntity(2,2, "Evangelion 3.0 + 1.0 Thrice Upon A Time", "", "2021-3-8", "popular")
        )
