...
//    }
    ...
    override fun getMovieDetails(id: Long, sessionId: String?): Flow<Resource<MovieDetails>> {
    ...
    override suspend fun setFavorite(id: Long, sessionId: String, addToFavorite: Boolean) {
        TODO("Not yet implemented")
    }
}